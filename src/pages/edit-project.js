            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-yellow-800">Resubmission Required</h3>
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>Please review the evaluation points below and go to the Create Project page to resubmit your project.</p>
                    </div>
                    <div className="mt-4">
                      <button
                        type="button"
