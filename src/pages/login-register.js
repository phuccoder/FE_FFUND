          ...
          <div className="flex-grow flex flex-col justify-center px-6 md:px-16 lg:px-24 py-8">
            {!showGoogleSetup && (
              <div className="flex mb-8 border-b border-gray-200">
                <button
                  type="button"
                  className={`flex-1 py-3 text-sm font-medium transition-all duration-200 ${activeTab === 'login'
                ...
                <button
                  type="button"
                  className={`flex-1 py-3 text-sm font-medium transition-all duration-200 ${activeTab === 'register'
                      ? 'border-b-2 border-yellow-500 text-yellow-600 font-semibold'
                      : 'text-gray-500 hover:text-gray-700'
                    }`}
